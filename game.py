...
pygame.display.set_caption("Covid Arcade")
...
class gameMenu:
    ...
    def displayInstructions(self):
        title = titleFont.render("- Covid Arcade -", True, (0,0,0))
        instructions1 = instructionFont.render("        Welcome to Covid Arcade!!", True, (0,0,0))
    ...
    def displayCredits(self):
        title = titleFont.render("- Covid Arcade -", True, (0,0,0))
        credit1 = font.render("  Developed by Deepanshu Taneja", True, (0,0,0))
